...
export default function GridCard({
  ...
  return (
    <div
      ...
      className="shadow-black bg-gray-100 hover:bg-red-100 rounded-md py-3 transition-all cursor-pointer"
    >
      <button
        className="ml-2 p-1 rounded-md self-start hover:bg-red-300 transition-all"
        onClick={onIconClick}
